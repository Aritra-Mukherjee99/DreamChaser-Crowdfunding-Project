...
import slide4 from "./assets/ProudToDonate4.jpg";
import slide5 from "./assets/ProudToDonate5.jpg";
  ...
  return (
    <React.Fragment>
      <div className={`col-11 m-auto ${styles.container}`}>
        ...
        alt="ProudToDonate4"
        className={
          proprety[3] === ".myactive" ? styles.myactive : styles.mynone
        }
        />
        <img
        src={slide5}
        alt="ProudToDonate5"
        className={
        proprety[4] === ".myactive" ? styles.myactive : styles.mynone
        }
        />
